...
class Mozambique implements CustomersPhoneNumbers, PhoneNumberValidation {

    public function validate($phoneNumber)
    {
        $valide = preg_match(MOZAMBIQUE_PHONE_Pattern, $phoneNumber);
    ...
    public function populateCustomersPhoneNumber($customers, $phoneNumberStatus)
    {
        ...
        while ($customer = $customers->fetchArray()) {
            ...
            $customerData = [
                "Country" => MOZAMBIQUE_COUNTRY,
                "Status" => $status,
                "CountryCode" => "+" . MOZAMBIQUE_PHONE_CODE,
