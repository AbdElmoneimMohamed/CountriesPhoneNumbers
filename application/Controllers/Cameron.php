...
class Cameron implements CustomersPhoneNumbers, PhoneNumberValidation {

    public function validate($phoneNumber)
    {
        $valide = preg_match(CAMERON_PHONE_Pattern, $phoneNumber);
    ...
    public function populateCustomersPhoneNumber($customers, $phoneNumberStatus)
    {
        ...
        while ($customer = $customers->fetchArray()) {
            ...
            $customerData = [
                "Country" => CAMERON_COUNTRY,
                "Status" => $status,
                "CountryCode" => "+" . CAMERON_PHONE_CODE,
